...
function ImageInput({ uploadedImg, handleDelete, handleImage, thumbnailImg }) {
  return (
                ...
                >
                  ...
                  >
                    ...
                    <span className="homec-image-video-upload__title homec-image-video-upload__title--v2">
                      Drag & Drop or{" "}
                      <span className="homec-primary-color">Choose File</span>{" "}
                      to upload{" "}
                    </span>
                  </label>
                </div>
