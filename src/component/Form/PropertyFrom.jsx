...
function PropertyFrom({ propertyInfo }) {
                ...
                <div className="homec-submit-form__inner">
                  <div className="row">
                    ...
                    <SelectInputV2
                      ...
                      setValue={(value) => {
                        setInput({ ...input, propertyType: value });
                      }}
                      options={[
                        {
                          id: 1,
                    ...
                    <SelectInputV2
                      ...
                      setValue={(value) => {
                        setInput({ ...input, rentPeriod: value });
                      }}
                      options={[
                        {
                          id: 1,
