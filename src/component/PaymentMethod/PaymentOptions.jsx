...
function PaymentOptions({ price }) {
  const paymentMethod = [
    { name: "payment-1", image: "img/payment-1.png", type: "online" },
    { name: "payment-2", image: "img/payment-2.png", type: "online" },
    { name: "payment-3", image: "img/payment-3.png", type: "online" },
    { name: "payment-4", image: "img/payment-4.png", type: "online" },
    { name: "payment-5", image: "img/payment-5.png", type: "bank" },
    {
      name: "payment-6",
      image: "img/payment-6.png",
      type: "credit-card",
    },
  ];
